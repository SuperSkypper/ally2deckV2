...
# How To Use:
- 1 - Download BuildDriver.ps1 and InstallDriver.ps1 from this repository.
...
- 4 - Right-click BuildDriver.ps1: Run with Powershell
  - This will build the new driver.
- 5 - Right-click InstallDriver.ps1: Run with Powershell
  - The script will install the Driver.
- 5 - Restart Windows to conclude installation.

If you want to uninstall, just right-click UninstallDriver.ps1 and restart.
